...
class ANDA(Attack):
    ...
    def forward(self, data, label, **kwargs):
        ...
        for t in range(self.epoch):
            ...
            noise = stat.noise_mean  # shape (1, C, H, W)
...
with open(index_file_absolute_path) as f:
...
for image_file in image_files:
    ...
    target_class = target_index_image_path(actual_image_absolute_path, index_file_absolute_path, weight_path, model_current)
    ...
    delta = attack.forward(x, torch.tensor([target_class], device=device))

...
for image_file in image_files:
    ...
    # Start timing for current image
    ...
    iterative_image_top1_label = np.zeros(140, dtype=int)
...
############################################################################################################################
    ...
    # End timing for current image
    end_time = time.time()
    image_time = end_time - start_time
    total_time += image_time
    print(f"Processing time for image {image_file}: {image_time:.2f} seconds")

print(f"The success rate of the attack is：{success_num / image_num}")
print(f"Total attack time: {total_time:.2f} seconds")
print(f"Average attack time per image: {total_time / image_num:.2f} seconds")

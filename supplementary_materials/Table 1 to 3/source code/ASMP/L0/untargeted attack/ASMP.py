...
for image_file in image_files:
    ...
    while flag == 0 and num_iterative < 140:
        ...
        if num_iterative == 1:
            ...
            for i in range(224):
                for j in range(224):
                    if iterative_image_pixel_classification_contribution_matrix_in_actual_label_R[i][j] * iterative_image_pixel_classification_contribution_matrix_in_attack_label_R[i][j] < 0:
                        feature_monotonicity_rate[0][i][j] = np.abs(iterative_image_pixel_classification_contribution_matrix_in_actual_label_R[i][j]) + np.abs(iterative_image_pixel_classification_contribution_matrix_in_attack_label_R[i][j])
                    if iterative_image_pixel_classification_contribution_matrix_in_actual_label_G[i][j] * iterative_image_pixel_classification_contribution_matrix_in_attack_label_G[i][j] < 0:
                        feature_monotonicity_rate[1][i][j] = np.abs(iterative_image_pixel_classification_contribution_matrix_in_actual_label_G[i][j]) + np.abs(iterative_image_pixel_classification_contribution_matrix_in_attack_label_G[i][j])
                    if iterative_image_pixel_classification_contribution_matrix_in_actual_label_B[i][j] * iterative_image_pixel_classification_contribution_matrix_in_attack_label_B[i][j] < 0:
                        feature_monotonicity_rate[2][i][j] = np.abs(iterative_image_pixel_classification_contribution_matrix_in_actual_label_B[i][j]) + np.abs(iterative_image_pixel_classification_contribution_matrix_in_attack_label_B[i][j])
        ...
        for i in range(224):
            for j in range(224):
                ############################################################################################################################################################################################
                if iterative_image_pixel_classification_contribution_matrix_in_attack_label_R[i][j] > 0 and iterative_image_pixel_classification_contribution_matrix_in_actual_label_R[i][j] < 0 and mark_matrix[0][i][j] == 1:
                ...
                if iterative_image_pixel_classification_contribution_matrix_in_attack_label_G[i][j] > 0 and iterative_image_pixel_classification_contribution_matrix_in_actual_label_G[i][j] < 0 and mark_matrix[1][i][j] == 1:
                ...
                if iterative_image_pixel_classification_contribution_matrix_in_attack_label_B[i][j] > 0 and iterative_image_pixel_classification_contribution_matrix_in_actual_label_B[i][j] < 0 and mark_matrix[2][i][j] == 1:
